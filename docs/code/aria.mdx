...
<Editor
  initialHtml='<h3>ARIA Landmarks Exercise</h3>
...
[Other ARIA roles are documented in the WCAG spec.](https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/Roles)
