  ...
  examples:
    - title: Landmark Regions
     ...
     ```jsx live
        ...
        <label>How many landmarks did you find on the page?
      ...
      note: |
        ...
        ARIA Landmarks were introduced before HTML5 added new [sectioning elements](https://w3c.github.io/aria-practices/#html-sectioning-elements): main, header, footer, aside, and section. Today's web browsers support the HTML tags as landmarks. 

        - `<main>`,`<div role="main">` -- This is the main section of the page. This landmark lets users skip the navigation and banner content and interact with the key information.

        - `<nav>`,`<div role="navigation">` -- contains a set of links or 
        elements for navigating the site. The aria-label identifies multiple navigation landmarks, such as aria-label="Main" and aria-label="Company information"

        - `<aside>`, `<div role="complementary">` - content that supplements 
        the main content

        - `<div role="search">` - Search forms are important for site navigation and this landmark makes it easy to find. 
        ...
        - `<section>`, `<div role="region">` - Regions are important subsections that people access at any time. A help panel is a good example. Use aria-label to identify the region in the screen reader's navigation menu. 
...
*** More Informative Resources : 
        ...
        - [Introduction to ARIA](https://developers.google.com/web/fundamentals/accessibility/semantics-aria)
         ...
         - [ARIA Landmarks Example (W3C)](https://w3c.github.io/aria-practices/examples/landmarks/index.html)

         - [Landmark Roles (MDN)](https://developer.mozilla.org/en-US/docs/Web/Accessibility/ARIA/Roles#3._landmark_roles)
